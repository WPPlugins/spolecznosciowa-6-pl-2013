...
Author: netporadnik.wkom.pl
Version: 2.0.5
Author URI: http://netporadnik.wkom.pl/
*/
...
// kod wyswietlania
   ...
   if($wkomsp_wykop) { 
      $wkomsp_buttonscode .= '<a href="http://www.wykop.pl/dodaj?url='.$link.'&title='.$tytul.'&desc='.$opis.'" target="_blank" onclick="javascript:window.open(this.href,\'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><img src="'.wkom_folder.'ikony/wykop24.png" title="Udostępnij na Wykopie" style="border-radius: 3px;box-shadow: 0 1px 4px rgba(0, 0, 0, 0.2);" /></a>';
   }

   $wkomsp_buttonscode .= '<a href="http://wp.wkom.pl" target="_blank"><img src="'.wkom_folder.'ikony/wt4.gif" title="Pobierz Społecznościową 6 PL 2013 dla WordPressa" style="background:none;width:8px;box-shadow:none;margin-bottom:16px;" /></a></div>
